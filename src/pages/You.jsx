          ...
          <section className='you-section'>
            ...
            {orders.length === 0 ? (
              <div className='you-empty'>
                ...
                <p>{tx.noOrders}</p>
                <Link to='/' className='continue-shopping-btn'>{tx.browseProducts}</Link>
              </div>
            ) : (
          ...
          <section className='you-section'>
            ...
            {cart.length === 0 ? (
              <div className='you-empty'>
                <span className='you-empty-icon'>🛒</span>
                <p>{tx.cartEmpty}</p>
                <Link to='/' className='continue-shopping-btn'>{tx.addItems}</Link>
              </div>
            ) : (
              <div className='draft-cart-card'>
                ...
                <div className='draft-cart-footer'>
                  ...
                  <Link to='/checkout' className='continue-shopping-btn'>{tx.goToCheckout}</Link>
                </div>
              </div>
            )}
          </section>
